...
_REGISTEREDPAYEE = DESCRIPTOR.message_types_by_name['RegisteredPayee']
_REGISTEREDCOUNTERPARTYPAYEE = DESCRIPTOR.message_types_by_name['RegisteredCounterpartyPayee']
...
FeeEnabledChannel = _reflection.GeneratedProtocolMessageType('FeeEnabledChannel', (_message.Message,), {
...
RegisteredPayee = _reflection.GeneratedProtocolMessageType('RegisteredPayee', (_message.Message,), {
...
RegisteredCounterpartyPayee = _reflection.GeneratedProtocolMessageType('RegisteredCounterpartyPayee', (_message.Message,), {
...
ForwardRelayerAddress = _reflection.GeneratedProtocolMessageType('ForwardRelayerAddress', (_message.Message,), {
