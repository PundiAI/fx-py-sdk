...
class WebsocketRpcClient(WebsocketManagerBase):
    ...
    @classmethod
    async def create(cls, endpoint_url: str, callback: Callable[[Dict], Awaitable[None]], loop=None):
        ...
        self._conn = ReconnectingRpcWebsocket(endpoint_url, recv=self._recv, loop=self._loop)
        return self
