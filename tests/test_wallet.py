...
class TestWallet(unittest.TestCase):
    def test_seed_to_address(self):
        ...
        self.assertEqual(private_key.to_address(prefix='mx'),
    ...
    def test_private_key_sign(self):
        ...
        self.assertEqual(priv_key.to_address('mx'), 'mx17w0adeg64ky0daxwd2ugyuneellmjgnxqezt98')
    ...
    def test_private_key_sign2(self):
        ...
        self.assertEqual(priv_key.to_address('mx'), 'mx15yk64u7zc9g9k2yr2wmzeva5qgwxps6y9kkkhe')
        self.assertEqual(priv_key.sign(priv_key_bytes).hex(),
